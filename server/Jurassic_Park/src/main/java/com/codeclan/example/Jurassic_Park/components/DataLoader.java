...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Paddock paddock = new Paddock("Malcolm Paddock", 1, 3, 4, true, false, game1);
        paddockRepository.save(paddock);
        Paddock paddock2 = new Paddock("Grant Paddock", 2, 6, 8, false, false, game1);
        paddockRepository.save(paddock2);
        Paddock paddock3 = new Paddock("Nedry Paddock", 2, 6, 8, false, false, game1);
        paddockRepository.save(paddock3);
        Paddock paddock4 = new Paddock("Sattler Paddock", 2, 6, 8, false, false, game1);
        paddockRepository.save(paddock4);
        Paddock paddock5 = new Paddock("Hammond Paddock", 2, 6, 8, false, false, game1);
        paddockRepository.save(paddock5);
        Paddock paddock6 = new Paddock("Murphy Paddock", 2, 6, 8, false, false, game1);
        paddockRepository.save(paddock6);
        Paddock paddock7 = new Paddock("Dodgson Paddock", 2, 6, 8, false, false, game1);
        paddockRepository.save(paddock7);
        Paddock paddock8 = new Paddock("Wu Paddock", 2, 6, 8, false, false, game1);
        paddockRepository.save(paddock8);
        Paddock paddock9 = new Paddock("Gennaro Paddock", 2, 6, 8, false, false, game1);
        paddockRepository.save(paddock9);
        Paddock paddock10 = new Paddock("Muldoon Paddock", 2, 6, 8, false, false, game1);
